    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/usuarios/encarregados/*")
                        .hasAnyRole("ADMIN", "GERENTE")
                        .requestMatchers(HttpMethod.PUT, "/usuarios/encarregados/*")
                        .hasAnyRole("ADMIN", "GERENTE")
                        ...
                        .hasAnyRole("ADMIN", "GERENTE")
                        .requestMatchers(HttpMethod.PUT, "/contratos/*")
                        .hasAnyRole("ADMIN", "GERENTE")
                        .requestMatchers(HttpMethod.PATCH, "/contratos/*/desativar", "/contratos/*/ativar")
                        .hasAnyRole("ADMIN", "GERENTE")
                        .requestMatchers(HttpMethod.DELETE, "/contratos/*")
                        .hasRole("ADMIN")
